...
LOGS_DIR = Path(
    r"C:\Users\hp\Desktop\leadsup\v0\gpt-web-search-approach-2\gpt-4o-mini\v2\logs")
LOGS_DIR.mkdir(parents=True, exist_ok=True)

# === PRICING CONFIG (for gpt-4o-mini with web search) ===
...
def process_domain(domain, expected_email, expected_form):
    ...
    try:
        ...
        input_tokens = 350
        output_tokens = 350
        estimated_cost = ((input_tokens / 1000) * PRICE_PER_1K_INPUT) + \
